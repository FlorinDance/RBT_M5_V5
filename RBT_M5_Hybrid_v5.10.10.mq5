//+------------------------------------------------------------------+
//| RBT_M5_Hybrid_v5.10.10.mq5                                      |
//| Normal RBT + Motif risk and proportional shadow policy lab.      |
//+------------------------------------------------------------------+
#property strict
#property version   "5.110"
#property description "RBT M5 v5.10.10 - tick-fill normal Motif policy lab"
...
int OnInit()
{
   ...
   PrintFormat("RBT M5 HYBRID v5.10.10 ready | mode=NORMAL_HYBRID | XGB BUY=%.3f SELL=%.3f GAP=%.3f | motif=%s | base lot=%.2f fixedSL=%.2f | policy_lab=%d prudent_A=%.1f/%.1f prudent_O=%.1f/%.1f permissive_A=%.1f/%.1f permissive_O=%.1f/%.1f",
