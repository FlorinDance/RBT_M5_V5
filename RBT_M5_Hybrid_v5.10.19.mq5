//+------------------------------------------------------------------+
//| RBT_M5_Hybrid_v5.10.19.mq5                                      |
//| Normal RBT + live recovery and trailing management.            |
//+------------------------------------------------------------------+
#property strict
#property version   "5.119"
#property description "RBT M5 v5.10.19 - combined global +10/+5 lock with Recovery Only filters"
