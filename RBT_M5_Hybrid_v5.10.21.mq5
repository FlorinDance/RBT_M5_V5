//+------------------------------------------------------------------+
//| RBT_M5_Hybrid_v5.10.21.mq5                                      |
//| Normal RBT + live recovery and trailing management.            |
//+------------------------------------------------------------------+
#property strict
#property version   "5.121"
#property description "RBT M5 v5.10.21 - live degradation B1/B2/D2 + global lock + Recovery + 10h05 timeout"
...
int OnInit()
{
   ...
   PrintFormat("DEGRADATION LIVE | enabled=%d time_stop=%.0fm B1=%.0f->%.0f confirm=%d..%ds B2=moves%d pips=%.1f/%.1f arm=%.0f confirm=%.0f D2=+%.0f/%.0fm",
      ...
      InpDegradationB2ConfirmLossMoney,InpDegradationD2AdditionalLossMoney,
      InpDegradationD2WindowMinutes);
