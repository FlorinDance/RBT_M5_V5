...
//+------------------------------------------------------------------+
#property strict
#property version   "5.122"
#property description "RBT M5 v5.10.22 - sampled B2 + 5m post-degradation cooldown + 10h05 timeout"
...
int OnInit()
{
   ...
   PrintFormat("DEGRADATION LIVE | enabled=%d time_stop=%.0fm B1=%.0f->%.0f confirm=%d..%ds B2=moves%d pips=%.1f/%.1f arm=%.0f confirm=%.0f sample=%ds D2=+%.0f/%.0fm cooldown=%.1fm",
      (int)InpDegradationProtection,InpCombinedTimeStopMinutes,
      InpDegradationB1FirstLossMoney,InpDegradationB1ConfirmLossMoney,
      InpDegradationB1ConfirmMinSeconds,InpDegradationB1ConfirmMaxSeconds,
      ...
      InpDegradationB2ConfirmLossMoney,InpDegradationSampleSeconds,
