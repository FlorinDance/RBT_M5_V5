...
//+------------------------------------------------------------------+
#property strict
#property version   "5.123"
#property description "RBT M5 v5.10.23 - B1 2-sample confirmation + split cooldowns + 10h05 timeout"
...
int OnInit()
{
   ...
   DegradationEntryCooldownInitialize();
   ...
   PrintFormat("DEGRADATION LIVE | enabled=%d time_stop=%.0fm B1=%.0f->%.0f x%d sample=%ds B2=moves%d pips=%.1f/%.1f arm=%.0f confirm=%.0f D2=+%.0f/%.0fm cooldown_B1B2=%.1fm cooldown_D2=%.1fm",
      (int)InpDegradationProtection,InpCombinedTimeStopMinutes,
      InpDegradationB1FirstLossMoney,InpDegradationB1ConfirmLossMoney,
      InpDegradationB1ConfirmSamples,InpDegradationSampleSeconds,
      InpDegradationB2ConsecutiveMoves,InpDegradationB2InitialAdversePips,
      InpDegradationB2RearmedAdversePips,InpDegradationB2ArmLossMoney,
      InpDegradationB2ConfirmLossMoney,
      InpDegradationD2AdditionalLossMoney,InpDegradationD2WindowMinutes,
      InpDegradationPostCloseCooldownMinutes,InpDegradationD2PostCloseCooldownMinutes);
