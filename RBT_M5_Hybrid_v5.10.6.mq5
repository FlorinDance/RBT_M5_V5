//+------------------------------------------------------------------+
//| RBT_M5_Hybrid_v5.10.6.mq5                                       |
//| XGBoost entry direction + hourly Motif quality risk assessment.  |
//+------------------------------------------------------------------+
#property strict
#property version   "5.106"
#property description "RBT M5 v5.10.6 - XGBoost + Motif quality risk"
...
int OnInit()
{
   ...
   PrintFormat("RBT M5 HYBRID v5.10.6 ready | mode=%s | XGB BUY=%.3f SELL=%.3f GAP=%.3f | motif=%s | base lot=%.2f fixedSL=%.2f | protect=%d arm=%.2f floor=%.2f",
